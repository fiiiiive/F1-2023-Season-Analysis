...
plot_size = [15,15]
plot_title = "Ferrari Qualifying Differences 2022 (White) v 2023 (Red)"
plot_ratios = [4, 2, 1]
plot_filename = "ferrariJEDDAHQuali22-23.png"
...
ax[0].plot(telemetry_d1['Distance'], telemetry_d1['Speed'], label = d1, color='red')
ax[0].plot(telemetry_d2['Distance'], telemetry_d2['Speed'], label = d2, color='white')
ax[0].set(ylabel = 'Speed')
ax[0].legend(loc="lower right")

ax[1].plot(telemetry_d1['Distance'], telemetry_d1['Throttle'], label = d1, color='red')
